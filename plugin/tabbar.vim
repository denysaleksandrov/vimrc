...
if ! hasmapto('1') || !hasmapto('<C-1>')
      "gui bindings containing META key, are different from terminal bindings
      if has('gui_running')
            "NORMAL mode bindings for gvim
            noremap <unique> <script> <C-1> :call <SID>Bf_SwitchTo( 1)<CR>:<BS>
            noremap <unique> <script> <C-2> :call <SID>Bf_SwitchTo( 2)<CR>:<BS>
            noremap <unique> <script> <C-3> :call <SID>Bf_SwitchTo( 3)<CR>:<BS>
            noremap <unique> <script> <C-4> :call <SID>Bf_SwitchTo( 4)<CR>:<BS>
            noremap <unique> <script> <C-5> :call <SID>Bf_SwitchTo( 5)<CR>:<BS>
            noremap <unique> <script> <C-6> :call <SID>Bf_SwitchTo( 6)<CR>:<BS>
            noremap <unique> <script> <C-7> :call <SID>Bf_SwitchTo( 7)<CR>:<BS>
            noremap <unique> <script> <C-8> :call <SID>Bf_SwitchTo( 8)<CR>:<BS>
            noremap <unique> <script> <C-9> :call <SID>Bf_SwitchTo( 9)<CR>:<BS>
            noremap <unique> <script> <C-0> :call <SID>Bf_SwitchTo( 10)<CR>:<BS>
            "INSERT mode bindings for gvim
            inoremap <unique> <script> <C-1> <esc>:call <SID>Bf_SwitchTo( 1)<CR>:<BS>a
            inoremap <unique> <script> <C-2> <esc>:call <SID>Bf_SwitchTo( 2)<CR>:<BS>a
            inoremap <unique> <script> <C-3> <esc>:call <SID>Bf_SwitchTo( 3)<CR>:<BS>a
            inoremap <unique> <script> <C-4> <esc>:call <SID>Bf_SwitchTo( 4)<CR>:<BS>a
            inoremap <unique> <script> <C-5> <esc>:call <SID>Bf_SwitchTo( 5)<CR>:<BS>a
            inoremap <unique> <script> <C-6> <esc>:call <SID>Bf_SwitchTo( 6)<CR>:<BS>a
            inoremap <unique> <script> <C-7> <esc>:call <SID>Bf_SwitchTo( 7)<CR>:<BS>a
            inoremap <unique> <script> <C-8> <esc>:call <SID>Bf_SwitchTo( 8)<CR>:<BS>a
            inoremap <unique> <script> <C-9> <esc>:call <SID>Bf_SwitchTo( 9)<CR>:<BS>a
            inoremap <unique> <script> <C-0> <esc>:call <SID>Bf_SwitchTo( 10)<CR>:<BS>a
      else
